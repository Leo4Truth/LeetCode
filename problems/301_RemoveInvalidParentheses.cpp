...
class Solution {
public:
    virtual vector<string> removeInvalidParentheses(string s) {
        return {};
    }
};

class Solution_backtrack_prune : public Solution {
public:
    vector<string> res;
...
class Solution_enumerate_status_subset : public Solution {
public:
...
int main(int argc, char* argv[]) {
    ...
    Solution *solution1 = new Solution_backtrack_prune();
    vector<string> res1 = solution1->removeInvalidParentheses(s);
    for (auto ss : res1) cout << ss << endl;

    Solution *solution2 = new Solution_BFS();
    vector<string> res2 = solution2->removeInvalidParentheses(s);
    for (auto ss : res2) cout << ss << endl;

    Solution *solution3 = new Solution_enumerate_status_subset();
    vector<string> res3 = solution3->removeInvalidParentheses(s);
    for (auto ss : res3) cout << ss << endl;
